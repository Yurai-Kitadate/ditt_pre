...
extension Product {
    static let mock1 = Product(
        id: 1, thumbnailURL: "turtlerock", title: "ditt!", introduction: "アイデアやプロトタイプを見れます。", ideaSection: "d", designSection: "e", technologySection: "f", teamSection: "Codephilia", createdAt: Data(), updatedAt: Data()
    )
